...
import com.tugas.submissionawal.view.DataDummy
import com.tugas.submissionawal.view.MainDispatcherRule
import com.tugas.submissionawal.view.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepo.getStory("storyToken")).thenReturn(expectedStory)
