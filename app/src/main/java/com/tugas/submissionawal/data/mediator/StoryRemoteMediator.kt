package com.tugas.submissionawal.data.mediator
...
import com.tugas.submissionawal.data.database.RemoteKeys
import com.tugas.submissionawal.data.database.StoryDatabase
import com.tugas.submissionawal.response.Story

@OptIn(ExperimentalPagingApi::class)
class StoryRemoteMediator (private val database: StoryDatabase, private val apiService: ApiService, private val token : String) : RemoteMediator<Int, Story>() {
